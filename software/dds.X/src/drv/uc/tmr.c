 ...
 */
static int8_t SetTimerFrequency(uint8_t type, uint32_t desiredFrequency, uint16_t *tmrRegisterValue, uint16_t *prescale);
...
static int8_t SetTimerFrequency(uint8_t type, uint32_t desiredFrequency, uint16_t *tmrRegisterValue, uint16_t *prescale) {
  ...
  uint16_t *p, n, ii;
  int8_t res = -1;
  uint16_t pA[4] = {1, 8, 64, 256};
  uint16_t pB[8] = {1, 2, 4, 8, 16, 32, 64, 256};
