...
/**
 * @function P2D_SpriteGetPixel
 * @brief return a pixel color #id
 * @param const uint8_t *ptr: sprite file
 * @param coord_t x, y: selected pixel
 * @return pixel color (correspond to an color id)
 */
uint8_t P2D_SpriteGetPixel(const uint8_t *ptr, coord_t x, coord_t y);
