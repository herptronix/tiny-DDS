...
extern const uint8_t FontBig[];
extern const uint8_t FontMedium[];
/*
...
extern const uint8_t sprite_background_lut[];
extern const uint8_t sprite_background[];
extern const uint8_t sprite_rbutton_lut[];
extern const uint8_t sprite_rbutton[];
extern const uint8_t sprite_box_lut[];
extern const uint8_t sprite_box[];
extern const uint8_t sprite_dds_button_lut[];
extern const uint8_t sprite_dds_button[];
extern const uint8_t sprite_in_out_lut[];
extern const uint8_t sprite_in_out[];
extern const uint8_t sprite_rvalue_lut[];
extern const uint8_t sprite_rvalue[];
extern const uint8_t sprite_logo_lut[];
extern const uint8_t sprite_logo[];
